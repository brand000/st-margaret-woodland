<div class="w3-panel">
  ...
  /*
          Author: Toufiq
          Purpose: This script file is used to deal with the retrieval of question data from the data base and their functioning
          */
  ...
  function createButtons($c, $a, $t, $d, $p2, $ar, $ind)
  {
    ...
    $button = array(
      "<input class=$a type=\"button\" style=$dis id=$a name=\"button1\" value=$a onclick=set(this)>",
